<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<table class="easyui-datagrid" id="carouselProje" title="商品列表"
	data-options="singleSelect:false,collapsible:true,pagination:true,url:'/kenya/content/pageQueryProject',method:'get',pageNumbers:1,pageSize:10, 
		rownumbers:true, 
	...
	<thead>
		<tr>
			...
			<th data-options="field:'categoryId',width:200">项目id</th>
			<th data-options="field:'pic',width:100">图片地址</th>
			<th data-options="field:'category',width:130">轮播项目</th>
							...
							.window(
									{
										onLoad : function() {
											//回显数据
											var data = $("#carouselProje").datagrid(
													"getSelections")[0];
