...
<link href="/kenya/js/kindeditor-4.1.10/themes/default/default.css" type="text/css" rel="stylesheet">
<script type="text/javascript" charset="utf-8" src="/kenya/js/kindeditor-4.1.10/kindeditor-all-min.js"></script>
<script type="text/javascript" charset="utf-8" src="/kenya/js/kindeditor-4.1.10/lang/zh_CN.js"></script>
<div style="padding:10px 10px 10px 10px">
	...
	<!--         <tr>
	        ...
	        <input type="hidden" name="category" value="url"/>
	    </table>
	</form>
...
<script type="text/javascript">
	...
	var contentAddPage  = {
			submitForm : function (){
				...
				$.post("/kenya/content/save",$("#contentAddForm").serialize(), function(data){
					if(data.status == 200){
