...
<table class="easyui-datagrid" id="itemParamList" title="商品列表" 
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/item/param/list',method:'get',pageSize:10, pageNumber:1,pageList: [5,10,15,20]toolbar:itemParamListToolbar">
    <thead>
        <tr>
